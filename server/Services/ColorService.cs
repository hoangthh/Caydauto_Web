...
public class ColorService : IColorService
{
    ...
    {
        var isColorCreated = await _colorRepository
            .IsColorCreatedAsync(colorCreateDto.Name)
    ...
    public async Task<bool> UpdateColorAsync(int id, ColorPutDto colorUpdateDto)
    {
        ...
        var isColorCreated = await _colorRepository
            .IsColorCreatedAsync(colorUpdateDto.Name, id)
            .ConfigureAwait(false);
        if (isColorCreated)
        {
    ...
    public Task<bool> IsColorUsedAsync(int id)
    {
        throw new NotImplementedException();
    }
}
